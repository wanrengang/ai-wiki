...
> 阅读量：25008  
> 分类：设计 | 标签：设计  
> 来源：[mdnice 墨滴](https://www.mdnice.com/writing/403fa6efbcdd46bb9827d5802b3d9906)
...
![M Logo](https://files.mdnice.com/logo.svg)
...
对于该论述，欢迎读者查阅之前发过的文章，[你是《未来世界的幸存者》么？](https://mp.weixin.qq.com/s/WwXj2J2UqS2yD0xICkksZg)
...
> 读一本好书，就是在和高尚的人谈话。 **——歌德**
>
> [Markdown Nice最全功能介绍](https://product.mdnice.com/articles/)
>
...
![同时设置宽度和高度](https://files.mdnice.com/logo.png =200x100)

![只设置宽度，推荐使用百分比](https://files.mdnice.com/logo.png =60%)

该语法比较特殊，其他 Markdown 编辑器不完全通用。

支持 jpg、png、gif、svg 等图片格式，**其中 svg 文件仅可在微信公众平台中使用**，svg 文件示例如下：

![svg](https://files.mdnice.com/i-am-svg.svg)
...
[![Markdown Nice 最全功能介绍](https://files.mdnice.com/dance.gif)](https://product.mdnice.com/articles/)
...
行内公式使用方法，比如这个化学公式：$CuSO_4+2NaOH=Cu(OH)_2\downarrow+Na_2SO_4$

块公式使用方法如下：

$$H(D_1) = -\left(\frac{2}{4}\log_2\frac{2}{4} + \frac{2}{4}\log_2\frac{2}{4}\right) = 1$$
...
<![](https://files.mdnice.com/blue.jpg),![](https://files.mdnice.com/green.jpg),![](https://files.mdnice.com/red.jpg)>
...
> 支持平台：微信公众号。 对于需要 2 列展示的内容，可以通过分列语法实现，可以设置左右比例，不设置时默认各为50%，示例如下：
...
<span style="color: orange; text-align: right;">橙色居右</span>

<span style="color: orange; text-align: center;">橙色居中</span>
...
[4] 更多文档: https://product.mdnice.com/articles/
